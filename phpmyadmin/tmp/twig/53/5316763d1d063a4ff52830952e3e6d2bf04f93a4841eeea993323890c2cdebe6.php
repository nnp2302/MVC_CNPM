...
class __TwigTemplate_12f3180a61b0c096b30d483e42c831751e65b7c3ad30252ec02731c244d6a185 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Type");
        ...
        if (($context["is_ajax"] ?? null)) {
            ...
            // line 30
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_type", [], "any", false, false, false, 30), "PROCEDURE"))) ? (" selected") : (""));
            echo ">PROCEDURE</option>
                <option value=\"FUNCTION\"";
            // line 31
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_type", [], "any", false, false, false, 31), "FUNCTION"))) ? (" selected") : (""));
...
echo _gettext("Parameters");
        ...
        // line 49
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_type", [], "any", false, false, false, 49), "FUNCTION"))) ? (" hide") : (""));
        echo "\">";
...
echo _gettext("Remove last parameter");
        ...
        // line 70
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_type", [], "any", false, false, false, 70), "PROCEDURE"))) ? (" hide") : (""));
        echo "\">
          <td>";
echo _gettext("Return type");
        ...
        <tr class=\"routine_return_row";
        // line 78
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_type", [], "any", false, false, false, 78), "PROCEDURE"))) ? (" hide") : (""));
        echo "\">
          <td>";
echo _gettext("Return length/values");
        ...
        <tr class=\"routine_return_row";
        // line 85
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_type", [], "any", false, false, false, 85), "PROCEDURE"))) ? (" hide") : (""));
        echo "\">
          <td>";
...
echo _gettext("Charset");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_returnopts_text", [], "any", false, false, false, 93), twig_get_attribute($this->env, $this->source, $context["charset"], "getName", [], "method", false, false, false, 93)))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["charset"], "getName", [], "method", false, false, false, 93), "html", null, true);
            echo "</option>
                ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["numeric_option"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_returnopts_num", [], "any", false, false, false, 101), $context["numeric_option"]))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["numeric_option"], "html", null, true);
            echo "</option>
                ";
...
echo _gettext("SQL data access");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["value"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["routine"] ?? null), "item_sqldataaccess", [], "any", false, false, false, 157), $context["value"]))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["value"], "html", null, true);
            echo "</option>
              ";
...
";
    ...
    {
        return new Source("", "database/routines/editor_form.twig", "C:\\xampp\\phpMyAdmin\\templates\\database\\routines\\editor_form.twig");
    }
}
