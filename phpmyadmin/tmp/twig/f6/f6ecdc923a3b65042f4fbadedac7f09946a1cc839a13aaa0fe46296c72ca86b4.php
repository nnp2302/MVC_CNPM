...
class __TwigTemplate_af50c83f68234803be93335fedf29c17000349cea1638f7167251344a36447a7 extends Template
{
    private $source;
    private $macros = [];
    ...
    <select name=\"item_param_dir[";
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["value"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare(($context["item_param_dir"] ?? null), $context["value"]))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["value"], "html", null, true);
            echo "</option>
      ";
    ...
    <select name=\"item_param_opts_num[";
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["value"]) {
            ...
            echo twig_escape_filter($this->env, $context["value"], "html", null, true);
            echo "\"";
            echo (((0 === twig_compare(($context["item_param_opts_num"] ?? null), $context["value"]))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["value"], "html", null, true);
            echo "</option>
      ";
...
";
    ...
    {
        return new Source("", "database/routines/parameter_row.twig", "C:\\xampp\\phpMyAdmin\\templates\\database\\routines\\parameter_row.twig");
    }
}
