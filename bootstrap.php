...
/*
*   Tự động load entities
*/
    $entities_dir = scandir('./app/entities');
    if(!empty($entities_dir)){
        foreach($entities_dir as $entity){
            if($entity!='.'&&$entity!='..'&& file_exists('./app/entities/'.$entity)){
                require_once './app/entities/'.$entity;
            }
        }
    }  
