...
<section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
    <div class="container">
        <p class="text-center">
            <a href="<?php echo _WEB_ROOT ?>/trang-chu" class="d-flex align-items-center justify-content-center">
        ...
        <div class="row justify-content-center form-bg-image" data-background-lg="<?php echo _WEB_ROOT;?>/app/public/assets/img/illustrations/signin.svg">
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                    ...
                    <form action="<?php echo _WEB_ROOT ?>/tao-tai-khoan" method="post" class="mt-4">
                                <!-- Form -->
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="example@company.com" id="email" name="username" autofocus required>
                                    </div>  
                                </div>
                                <!-- End of Form -->
                                    ...
                                    <div class="mb-4">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label fw-normal mb-0" for="remember">
                                                Tôi chấp nhận các <a href="#" class="fw-bold">điều khoản và điều kiện</a>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-gray-800" id="btn-sign-up">Đăng kí</button>
                                </div>
                            </form>
                    ...
                    <div class="d-flex justify-content-center align-items-center mt-4">
                        <span class="fw-normal">
                            Đã có tài khoản ?
                            <a href="./sign-in.html" class="fw-bold">Đăng nhập</a>
                        </span>
                    </div>
                </div>
            </div>
